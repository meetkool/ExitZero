...
// Generate a random-ish suffix to avoid collisions if you don't change it
const TOPIC = "exitzero-worker-" + Math.random().toString(36).substring(7); // 🔑 Change this to something you prefer!
